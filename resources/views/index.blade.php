    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <p>- Meja Billiard Menggunakan meja billiard dengan ukuran standar internasional, Meja terbuat dari bahan
                    berkualitas tinggi dengan permukaan yang rata dan bantalan yang sesuai untuk pantulan bola yang akurat.
                    </br>- Peralatan Bola billiard dan stick (cue) yang digunakan harus memenuhi standar internasional dalam
                    hal ukuran, berat, dan bahan. Bola billiard berkualitas tinggi yang memberikan ketahanan dan performa
                    yang optimal.
                    </br>- Pencahayaan: Pencahayaan yang memadai dan seragam di seluruh meja untuk menghindari bayangan dan
                    memastikan pemain dapat melihat bola dengan jelas. Lampu dipasang pada ketinggian tertentu untuk
                    memberikan pencahayaan yang ideal.
                    </br>- Lantai dan Lingkungan, Lantai terbuat dari bahan yang tahan lama dan tidak licin, seperti karpet
                    . Suasana ruangannya nyaman, dengan ventilasi yang baik dan suhu yang terkontrol.
                    </br>- Perawatan, Meja dan peralatan billiard harus dirawat secara rutin untuk menjaga kualitas dan
                    performanya. Ini termasuk perawatan kain meja, pengecekan dan penggantian bantalan, serta pembersihan
                    bola dan stick.
                    </br>- Fasilitas Tambahan, dilengkapi dengan fasilitas tambahan seperti bar atau kafe, ruang tunggu yang
                    nyaman, toilet yang bersih.
                        ...
                        @if ($review->status)
                            <div class="swiper-slide slide">
                                ...
                                <div class="userrev">
                                    ...
                                    @else
                                        <img src="{{ asset('images/profile/' . $review->user->image) }}"
                                            alt="user-image">
                                    @endif
